                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <sec:ifAnyGranted roles='ROLE_ADMIN,ROLE_DEV,ROLE_USER'>
                            <li><a href="${request.contextPath}/GwSiteRef"><i class="fa fa-circle-o"></i> GW_SITE_REF</a></li>
                            <li><a href="${request.contextPath}/LangCode"><i class="fa fa-circle-o"></i> LangCode Mapping</a></li>
                        </sec:ifAnyGranted>
                        <sec:ifAnyGranted roles='ROLE_ADMIN'>
                            <li><a href="${request.contextPath}/GwPrjRef"><i class="fa fa-circle-o"></i> GW_PRJ_REF</a></li>
                            <li><a href="${request.contextPath}/GwFuncRef"><i class="fa fa-circle-o"></i> GW_FUNC_REF</a></li>
                            <li><a href="${request.contextPath}/GwXml"><i class="fa fa-circle-o"></i> GW_XML</a></li>
                            <li><a href="${request.contextPath}/GwDeploy"><i class="fa fa-circle-o"></i> GW_DEPLOY</a></li> 
                        </sec:ifAnyGranted>
                    </ul>
                </li>
