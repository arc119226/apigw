        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">${message(code: 'gwPrjRef.label', default: 'GwPrjRef')}</h3>
                </div>
                <div class="box-body">
                    ...
                    <g:hasErrors bean="${this.gwPrjRef}">
                        <ul class="errors alert alert-danger" role="alert">
                            <g:eachError bean="${this.gwPrjRef}" var="error">
